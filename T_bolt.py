...
def create_stepped_tube():
    ...
    # Save result to file (required for terminal execution)
    doc.saveAs(r"c:\Users\shashank\Desktop\New folder (4)\SteppedTube_Output.FCStd")
    print(r"File saved to: c:\Users\shashank\Desktop\New folder (4)\SteppedTube_Output.FCStd")
